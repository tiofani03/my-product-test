...
class RadioButtonProductFilterAdapter(
    selectedActualFilter: DropdownItem? = null,
) : RecyclerView.Adapter<RadioButtonProductFilterAdapter.ViewHolder>() {

    private var filterList: MutableList<DropdownItem> = mutableListOf()

    fun setData(list: List<DropdownItem>) {
        filterList.clear()
